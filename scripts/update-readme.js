    ...
    for(let item of playlist.items) {
      ...
      if(countries[countryCode]) { 
        ...
        countries[countryCode] = { 
          country: countryName, 
          channels: 1, 
          playlist: `<code>https://akacry.github.io/tvannou/countries/${countryCode}.m3u</code>`, 
          epg: countryEpg
        }
      }
      ...
      if(languages[languageCode]) { 
        ...
        languages[languageCode] = { 
          ...
          channels: 1, 
          playlist: `<code>https://akacry.github.io/tvannou/languages/${languageCode}.m3u</code>` 
        }
      }
      ...
      if(categories[categoryCode]) {
        ...
        categories[categoryCode] = { 
          ...
          channels: 1, 
          playlist: `<code>https://akacry.github.io/tvannou/categories/${categoryCode}.m3u</code>` 
        }
      }
    }
  }
